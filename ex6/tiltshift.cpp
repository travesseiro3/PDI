...
int main(int argvc, char** argv){
  image1 = imread("Fotos/blend1.jpg");
  image2 = imread("Fotos/blen2.jpg");
...
/*
  ...
  Mat degrade = Mat::zeros(256, 256, CV_32F);
  scaleAdd(degrade, 125, Mat::zeros(256, 256, CV_32F), degrade);

  imshow("addweighted", degrade);
*/
/*
